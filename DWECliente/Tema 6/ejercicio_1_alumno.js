...
function ejercicio1() {
    ...
    var estudiante = {
        ...
        mostrarInfo: function () {
            ...
            var información = ` ${this.nombre} ${this.apellidos}, ${this.edad} años, Curso: ${this.curso}`;
            return ` <div class="card bg-info"><div class="card-body"> Alumno:   ${información} </div></div>`; // Cambiar esta línea
        }
    };

    // TODO: Mostrar el resultado en el DOM
    // Pista: usar document.getElementById("resultado-ej1").innerHTML = estudiante.mostrarInfo();
    const info = document.getElementById('resultado-ej1');
    info.innerHTML = estudiante.mostrarInfo();
}
...
function agregarColor() {
    ...
    document.getElementById("resultado-ej2").innerHTML =
        "<div class='alert alert-success'>Color agregado: " + color.value + "</div>";
}

function eliminarUltimoColor() {
    // TODO: Eliminar el último elemento del array usando pop()
    var eliminar = colores.pop();
    document.getElementById("resultado-ej2").innerHTML =
        "<div class='alert alert-warning'>Color eliminado: " + eliminar + "</div>";
    // TODO: Mostrar mensaje indicando qué color se eliminó
    // TODO: Si el array está vacío, mostrar mensaje apropiado
    if (colores.length === 0) {
        document.getElementById("resultado-ej2").innerHTML +=
            "<div class='alert alert-danger'>No hay colores para eliminar</div>";
    }
}
...
function cargarProductos() {
    ...
    productos = [
        ...
        { nombre: "Portatil", precio: 1399, categoria: "Electrónicos" },
        { nombre: "Camiseta", precio: 25, categoria: "Ropa" },
        { nombre: "Movil", precio: 1399, categoria: "Electrónicos" },
        { nombre: "Zapatillas", precio: 150, categoria: "Calzado" },
        { nombre: "Ratón", precio: 120, categoria: "Electrónicos" }
    ];
...
function ordenarPorPrecio() {
    ...
    productos.sort(function (menor, mayor) {
...
function filtrarProductosCaros() {
    ...
    // Filtramos el array global 'productos' por precio mayor a 50
    var productosCaros = productos.filter(function (p) {
        return p.precio > 50;
    });
...
function mostrarProductos(arrayProductos) {
    ...
    // Mostrar productos en tarjetas usando la clase .producto-item definida en el HTML
    html = "<div class='row'>";
...
var estudianteNotas = {
    ...
    agregarNota: function (nota) {
        ...
        if (nota >= 0 && nota <= 10) {
            ...
            document.getElementById("resultado-ej4").innerHTML =
                "<div class='alert alert-success'>Nota agregada: " + nota + "</div>";
        } else {
            document.getElementById("resultado-ej4").innerHTML =
    ...
    calcularPromedio: function () {
        ...
        var promedio = this.notas.length > 0 ? suma / this.notas.length : 0;
        return promedio.toFixed(2);// Cambiar esta línea
...
function cargarEmpleados() {
    ...
    empleados = [
        ...
        { nombre: "Sofía", departamento: "Ventas", salario: 3500, antiguedad: 4 },
...
function mostrarEmpleados(arrayEmpleados) {
    ...
    if (arrayEmpleados.length === 0) {
        ...
        html = "<table class='table table-striped'><thead><tr><th>Nombre</th><th>Departamento</th><th>Salario (€)</th><th>Antigüedad (años)</th></tr></thead><tbody>";
        for (var i = 0; i < arrayEmpleados.length; i++) {
            var emp = arrayEmpleados[i];
            html += "<tr>" +
                "<td>" + emp.nombre + "</td>" +
...
function buscarMadrid() {
    ...
    if (ciudadEncontrada) {
        html += "<p>Ciudad encontrada: " + ciudadEncontrada + "</p>";
...
function mostrarInfoVehiculos() {
    ...
    for (var i = 0; i < vehiculos.length; i++) {
        ...
        html += "<div class='card mb-2'><div class='card-body'>" +
            ...
            "<p><strong>Velocidad:</strong> " + v.velocidad + " km/h</p>" +
            "</div></div>";
    }
...
function sumarConReduce() {
    ...
    suma = numeros.reduce(function(acumulador, numero) {
...
function agregarLibro() {
    ...
    // TODO: Mostrar mensaje de confirmación
    document.getElementById("resultado-ej10").innerHTML =
        "<div class='alert alert-success'>Libro agregado: " + titulo + "</div>";
